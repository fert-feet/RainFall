...
NAME_FEATURES_PROJECT = NAME_FEATURES_WAVELET
NUM_N_FEATURE = N_LEVEL_WAVELET
...
NAME_WAVE_TRAIN_FEATURES_FILE = f"train_features_{NAME_FEATURES_WAVE}_n_{N_WAVE}"
NAME_WAVE_TEST_FEATURES_FILE = f"test_features_{NAME_FEATURES_WAVE}_n_{N_WAVE}"
NAME_WAVELET_TRAIN_FEATURES_FILE = f"train_features_{NAME_FEATURES_WAVELET}_n_{N_LEVEL_WAVELET}"
NAME_WAVELET_TEST_FEATURES_FILE = f"test_features_{NAME_FEATURES_WAVELET}_n_{N_LEVEL_WAVELET}"
